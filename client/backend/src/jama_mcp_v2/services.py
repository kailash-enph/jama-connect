...
# LAN cache server URL (optional — enables fast DB download for new users)
CACHE_SERVER_URL = os.environ.get("JAMA_CACHE_SERVER_URL", "")
...
class ServiceRegistry:
    ...
    def __init__(self) -> None:
        ...
        self.cache_server_url: str = CACHE_SERVER_URL   # LAN cache server base URL
